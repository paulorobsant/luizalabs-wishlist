...
def upgrade():
    ...
    sa.Column('email_suffix', sa.String(length=128), nullable=False),
    ...
    op.create_index(op.f('ix_public_match_cluster_value'), 'match_cluster', ['value'], unique=False, schema='public')
...
def downgrade():
    ...
    op.drop_index(op.f('ix_public_match_cluster_value'), table_name='match_cluster', schema='public')
    op.drop_table('match_cluster', schema='public')
